...
const objDesc = (repo, obj) => (obj ? `${repo.typeDef.typeName}:${repo.typeDef.id(obj)}` : `${obj}`);
export const ormScan = (scanner, scan) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (scanner.now() - timeoutStart < scanTimeout) {
        ...
        const objTypeAndId = objDesc(repo, obj);
        ...
        try {
            rollback = obj;
            updated = yield repo.update(scan.caller, obj);
            ...
            try {
                ...
                if (!scanner.stopping && rollback == null) {
                    ...
                    try {
                        yield repo.update(scan.caller, updated);
                    }
                    catch (e3) {
...
//# sourceMappingURL=ormScan.js.map